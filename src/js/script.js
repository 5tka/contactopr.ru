$(document).ready(function(){
   ...
   //  var animation = false;
    ...
    //         hi.animate({opacity: 1, width: '265px', height: '600px', left: '0px', top: '40px', backgroundPositionY: '30px'}, 1000, 'swing', function() {hi.removeClass('item_hidden'); hi.addClass('item_left');});
    //         li.animate({width: '356px', height: '700px', left: '332px', top: '0px', backgroundPositionY: '0px'}, 1000, 'swing', function() {li.removeClass('item_left'); li.addClass('item_center');});
    //         ci.animate({width: '265px', height: '600px', left: '755px', top: '40px', backgroundPositionY: '30px'}, 1000, 'swing', function() {ci.removeClass('item_center'); ci.addClass('item_right');});
